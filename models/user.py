...
from sqlalchemy import String, DateTime, func, VARCHAR
from datetime import datetime
from models.mixins.int_id_pk_mixin import IntIdPkMixin


class User(IntIdPkMixin, Base):
    name: Mapped[str] = mapped_column(VARCHAR(64), nullable=True)
    surname: Mapped[str] = mapped_column(VARCHAR(64), nullable=True)
