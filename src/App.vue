...
html[data-theme='dark'] .profile-card .telegram-section {
  --telegram-divider: #334155 !important;
  --telegram-soft-bg: rgba(15, 23, 42, 0.84) !important;
  --telegram-soft-bg-strong: rgba(15, 23, 42, 0.94) !important;
  --telegram-soft-border: #334155 !important;
  --telegram-text-main: #f8fafc !important;
  --telegram-text-secondary: #94a3b8 !important;
  --telegram-shadow: 0 24px 42px rgba(2, 6, 23, 0.28) !important;
  --telegram-pill-bg: rgba(30, 41, 59, 0.92) !important;
  --telegram-pill-text: #cbd5e1 !important;
}

html[data-theme='dark'] .profile-card .telegram-status-card,
html[data-theme='dark'] .profile-card .telegram-panel,
html[data-theme='dark'] .profile-card .telegram-waiting-card {
  border-color: #334155 !important;
  box-shadow: 0 24px 42px rgba(2, 6, 23, 0.28) !important;
}

html[data-theme='dark'] .profile-card .telegram-status-card {
  background: linear-gradient(180deg, rgba(15, 23, 42, 0.88), rgba(17, 24, 39, 0.94)) !important;
}

html[data-theme='dark'] .profile-card .telegram-status-card.is-connected {
  background:
      radial-gradient(circle at top right, rgba(34, 197, 94, 0.14), transparent 34%),
      linear-gradient(180deg, rgba(15, 23, 42, 0.88), rgba(17, 24, 39, 0.94)) !important;
}

html[data-theme='dark'] .profile-card .telegram-status-card.is-pending {
  background:
...
html[data-theme='dark'] .profile-card .telegram-panel,
html[data-theme='dark'] .profile-card .telegram-waiting-card,
html[data-theme='dark'] .profile-card .telegram-subscription-item,
html[data-theme='dark'] .profile-card .telegram-inline-note,
html[data-theme='dark'] .profile-card .telegram-empty-state,
html[data-theme='dark'] .profile-card .telegram-segmented {
  background: rgba(15, 23, 42, 0.94) !important;
  border-color: #334155 !important;
}

html[data-theme='dark'] .profile-card .telegram-select {
...
html[data-theme='dark'] .profile-card .telegram-select:focus {
  border-color: #3b82f6 !important;
}

html[data-theme='dark'] .profile-card .telegram-primary-btn {
  background: linear-gradient(135deg, #2563eb, #1d4ed8) !important;
  border-color: rgba(96, 165, 250, 0.28) !important;
  color: #ffffff !important;
}

html[data-theme='dark'] .profile-card .telegram-primary-btn:hover:not(:disabled) {
  background: linear-gradient(135deg, #3b82f6, #2563eb) !important;
}

html[data-theme='dark'] .profile-card .telegram-secondary-btn {
  background: rgba(15, 23, 42, 0.92) !important;
  border-color: #334155 !important;
  color: #cbd5e1 !important;
}

html[data-theme='dark'] .profile-card .telegram-secondary-btn:hover:not(:disabled) {
  background: rgba(30, 41, 59, 0.96) !important;
  color: #f8fafc !important;
}

html[data-theme='dark'] .profile-card .telegram-secondary-btn.is-danger,
html[data-theme='dark'] .profile-card .telegram-remove-btn {
  background: rgba(127, 29, 29, 0.2) !important;
  border-color: rgba(248, 113, 113, 0.16) !important;
  color: #fda4af !important;
}

html[data-theme='dark'] .profile-card .telegram-secondary-btn.is-danger:hover:not(:disabled),
html[data-theme='dark'] .profile-card .telegram-remove-btn:hover:not(:disabled) {
  background: rgba(127, 29, 29, 0.3) !important;
  color: #fecaca !important;
}

html[data-theme='dark'] .profile-card .telegram-status-title,
html[data-theme='dark'] .profile-card .telegram-panel-title,
html[data-theme='dark'] .profile-card .telegram-subscription-title,
html[data-theme='dark'] .profile-card .telegram-empty-state strong,
html[data-theme='dark'] .profile-card .telegram-waiting-head strong {
  color: #f8fafc !important;
}

html[data-theme='dark'] .profile-card .telegram-status-text,
html[data-theme='dark'] .profile-card .telegram-status-note,
html[data-theme='dark'] .profile-card .telegram-panel-subtitle,
html[data-theme='dark'] .profile-card .telegram-subscription-meta,
html[data-theme='dark'] .profile-card .telegram-inline-note,
html[data-theme='dark'] .profile-card .telegram-empty-state,
html[data-theme='dark'] .profile-card .telegram-empty-state span,
html[data-theme='dark'] .profile-card .telegram-waiting-card p,
html[data-theme='dark'] .profile-card .telegram-waiting-head span,
html[data-theme='dark'] .profile-card .telegram-form-group label,
html[data-theme='dark'] .profile-card .telegram-loading-state {
  color: #94a3b8 !important;
}

html[data-theme='dark'] .profile-card .telegram-status-id,
html[data-theme='dark'] .profile-card .telegram-counter,
html[data-theme='dark'] .profile-card .telegram-tag {
  background: rgba(30, 41, 59, 0.92) !important;
  color: #cbd5e1 !important;
}

html[data-theme='dark'] .profile-card .telegram-status-pill.is-connected {
  background: rgba(22, 163, 74, 0.22) !important;
  color: #86efac !important;
}

html[data-theme='dark'] .profile-card .telegram-status-pill.is-pending,
html[data-theme='dark'] .profile-card .telegram-tag.accent,
html[data-theme='dark'] .profile-card .telegram-segmented-btn.active {
  background: rgba(37, 99, 235, 0.2) !important;
  color: #bfdbfe !important;
}

html[data-theme='dark'] .profile-card .telegram-segmented-btn {
  color: #94a3b8 !important;
}

html[data-theme='dark'] .profile-card .telegram-segmented-btn:hover:not(.active) {
  color: #cbd5e1 !important;
}
